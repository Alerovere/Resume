...
\highlightbar{
    \section[\faLightbulbO]{In a nutshell}
I mentored postdoctoral researchers and supervised (or co-supervised) Ph.D. students in different countries and coming from different cultural backgrounds. \\ \\ I supervised or co-supervised several theses both at bachelor and master level in different European universities.}
...
\mainbar{
    ...
    \publication
	{} % Title
	{\textbf{Dr. Ciro Cerrone}} % Authors
	{Since 2023} % Year
	{Last Interglacial sea-level changes in Brazil} % Journal
	{} % ADS & arxiv links
    \publication
	{} % Title
...
\smallskip
    ...
    \publication
	{\textbf{Title:} Movimenti verticali del suolo nell’area nord della Laguna di Venezia durante l’Olocene} % Title
	{\textbf{Andrea Osti}} % Authors
	{2024} % Year
	{Ca' Foscari University of Venice (IT)} % Journal
	{} % ADS & arxiv links
...
\smallskip
    ...
    \publication
	{\textbf{Title:} A methodology to compare sea-level index points and sea-level models} % Title
	{\textbf{Juan Sebastian Garzòn Alvarado}} % Authors
	{2022} % Year
	{University of Münster (DE)} % Journal
	{} % ADS & arxiv links
...
\smallskip
	...
	{2020} % Year
	{Università degli studi di Genova (IT)} % Journal
	{} % ADS & arxiv links
\smallskip
\hrule
\smallskip
...
\smallskip
	...
	{2016} % Year
	{EPHE-CRIOBE-Université de Perpignan (FR)} % Journal
	{} % ADS & arxiv links
\smallskip
\hrule
\smallskip
...
\smallskip
    \publication
	{\textbf{Title:} Valutazione spostamento di un mega-masso lungo una costa rocciosa sfruttando equazioni idrodinamiche} % Title
	{\textbf{Enrico Muletto}} % Authors
	{2024} % Year
	{Ca' Foscari University of Venice (IT)} % Journal
	{} % ADS & arxiv links
\smallskip
...
\smallskip
    \publication
	{\textbf{Title:}Indagare le potenzialità della Structure from Motion assistita da LiDAR: un caso di studio sul gruppo alpino Civetta Moiazza} % Title
	{\textbf{Matilde Perciballi}} % Authors
	{2023} % Year
	{Ca' Foscari University of Venice (IT)} % Journal
	{} % ADS & arxiv links
\smallskip
...
\smallskip
    \publication
	{\textbf{Title:} Mappatura GIS delle beachrocks presenti lungo un tratto di Riviera ligure di Ponente e considerazioni riguardo il loro utilizzo come indicatori della variazione del livello del mare dall’età pre-industriale } % Title
	{\textbf{Giorgio Stocco}} % Authors
	{2023} % Year
	{Ca' Foscari University of Venice (IT)} % Journal
	{} % ADS & arxiv links
\smallskip
...
\highlightbar{
    \section[\faLightbulbO]{In a nutshell}
    I am a contributing author of the IPCC 6th Assessment Report. I am the President of the "Coastal and Marine Processes" commission of the International Union of Quaternary Sciences. I have led two international working groups on paleo sea-level changes, and I have been convener or co-convener of several sessions at several international conferences. I have also co-organised several workshops and meetings. \\ \\
...
\achievement{\textbf{Since 2024.} Coordinator of the degree course (MSc and BSc) in Environmental Sciences at Ca' Foscari University of Venice (Ca' Foscari DAIS Department Council, 26.03.2024)} 
\achievement{\textbf{Since 2023.} President of the "Coastal and Marine Processes" commission of the International Union for Quaternary Sciences (INQUA)} 
...
\achievement{\textbf{Since 2022.} Member of the Steering Committee of the "Instabilities and Thresholds in Antarctica (INSTANT) of the Scientific Committee on Antarctic Research}  
...
\achievement{\textbf{Since 2015.} Reviewer for research proposals to the Swiss Science Foundation; Humboldt Foundation; Israel Science Foundation; The Petroleum Research Fund (American Chemical Society); University of Singapore; National Geographic}
}
\makebody
\clearpage
...
\highlightbar{
    \section[\faLightbulbO]{In a nutshell}
    I oragnised several international conferences and workshops, and I regularly convene sessions at major international meetings.}

\mainbar{
\section[\faInstitution]{Organization of meetings}
\subsection{Conferences, workshops and convened sessions}
\achievement{\textbf{2023.} Convener and session chair of Session 89 "Cenozoic sea-level indicators and ice sheet constraints to global sea-level change" at the INQUA conference in Rome (July 2023)} 
...
\highlightbar{
    \section[\faLightbulbO]{In a nutshell}
My research activities were reported by several media outlets, including newspapers \faNewspaperO, radios \faVolumeUp, TV channels \faVideoCamera, and websites \faGlobe. I run my own podcast and I maintain a YouTube channel with playlists dedicated to education in the geosciences}

\mainbar{
\section[\faQuoteRight]{Outreach and media reports}
\weboutreach{\textbf{2023.} Aruba’s Bocas: home to the rarest fossil reefs on the planet!\\ \textit{Aruba Today (AW)}}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{img/authorship.png} 
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{img/citations.png} 
\end{figure}
...
\input{research_products.txt}
The names of articles by postdocs, Ph.D. or master students authored while under my mentoring are \underline{underlined}
