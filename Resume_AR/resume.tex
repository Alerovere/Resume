...
\smallskip
    ...
    \publication
	{\textbf{Title:} Evaluating the potential of nearshore Satellite-Derived Bathymetry (SDB) for Moorea Island (French Polynesia) using various data sets} % Title
...
\smallskip
    \publication
	{\textbf{Title:} Valutazione degli effetti della pesca del dattero di mare (Lithophaga lithophaga) sulla tessitura dei clasti al piede della falesia} % Title
